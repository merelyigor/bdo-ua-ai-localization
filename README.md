...
`keep_alive` тримав ОБИДВІ збірки в памʼяті, 23 + 33 ГБ на 69 ГБ RAM, і крок
QA, який звичайно триває 55-142 с, одного разу не завершився й за 11 хвилин.
Тому `./bdo bench` тепер сам вивантажує чужу модель перед виміром.)
