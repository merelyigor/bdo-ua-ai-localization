...
- Пачками по 10-25 рядків, з памʼяттю перекладів і глосарієм: половина рядків
...
| Модель диригента | будь-яка платна в OpenCode; перевірені GPT-5.6 Luna і MiMo V2.5 |
