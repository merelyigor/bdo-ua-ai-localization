...
#
#   ./bdo runtime          # перевірити активну модель субагентів
#
...
# Клієнт передає явний стан thinking і не вимикає його автоматично. Довгі
# різні роздуми дозволені, а повторюваний потік має окрему причину зупинки.
echo "OK (перевірено клієнтом: explicit think, thinking_loop, timeout)"
