...
Переліку патчів API не віддає, тому огляд будується від активного вниз:

    ./bdo patches          # усі патчі: скільки рядків без machine і без manual
    ./bdo patches 5        # лише останні пʼять
