...
| Команда | Призначення |
| --- | --- |
| `./bdo audit` | аудит сесій субагентів за базою OpenCode · **для розробки**, диригент флоу цю команду не запускає |
| `./bdo inspect [тека]` | інспекції PhpStorm по проєкту; працює лише при закритій IDE · **для розробки**, диригент флоу цю команду не запускає |
| `./bdo review` | стан проєкту одним екраном: плани, дефекти, черга, останні пачки · **для розробки**, диригент флоу цю команду не запускає |
| `./bdo session [N] [--errors]` | останні кроки сесії диригента: виклики, відмови й причини · **для розробки**, диригент флоу цю команду не запускає |
