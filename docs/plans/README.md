...
| План | Створено | Відомі зовнішні gates |
|---|---|---|
| [2026-09-04_GLOSSARY_INFLECTION_QUESTION.md](backlog/2026-09-04_GLOSSARY_INFLECTION_QUESTION.md) · чи зараховує сканер глосарія відмінкову форму: від відповіді залежить, чи можна ставити `glossary_confirmed` | 2026-09-04 | Питання до серверного агента, не зміна тут. Блокує вибір рішення для D53: без відповіді будь-який наш хід із `glossary_confirmed` буде здогадом. |
