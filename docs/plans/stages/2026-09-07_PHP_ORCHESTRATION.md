...
**Статус:** наступний у черзі · не починався. Рішення власника 2026-09-12: з
цього підетапу етап веде ОДНА локальна сесія, флоу АРХІТЕКТОР+ВИКОНАВЕЦЬ
зупинено (`AGENTS.md`, «Хто ти в цьому проєкті»). Пакети, review-кола й
HANDOFF більше не застосовуються; приймання · `./bdo gate full` із кодом 0,
CI на точному SHA і перевірка власником. Частини роботи можуть іти на
сабагентів або Codex за `docs/DELEGATION.md`, але спосіб питається ПЕРЕД
роботою, а рішення лишаються в головній сесії.
