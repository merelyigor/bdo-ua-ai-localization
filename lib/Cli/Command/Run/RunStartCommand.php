...
формулювання власника · вона вже оголошена в `.env` константою BDO_ENV.
  ...
  ./bdo run start                 # почати прогін у середовищі з .env
  ./bdo run show                  # яка ціль зафіксована зараз
  ./bdo run end                   # завершити прогін, зняти фіксацію
...
частина перекладів поїде не туди. ./bdo commit звіряє кожну пачку із цим
