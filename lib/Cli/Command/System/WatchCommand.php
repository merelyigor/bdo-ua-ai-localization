 ...
 * через `--show`.
 */
final class WatchCommand implements Command, \Bdo\Translate\Cli\CommandHelp
{
...
Запустити довгу роботу в СПРАВЖНЬОМУ терміналі, який видно власникові.
  ...
  ./bdo watch loop --batches 1     прогін у сесії tmux `bdo`
  ./bdo watch tui                  вікно в сесії tmux `bdo`
  ./bdo watch --show               показати поточний екран сесії
  ./bdo watch --stop               прибрати сесію
