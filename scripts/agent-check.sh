...
check_delegation_contract() {
    ...
    grep -Fq '## 🎯 Підсумок' AGENTS.md \
        || fail 'карта правил не містить заголовка «## 🎯 Підсумок» · формат фінального звіту можна змінити непомітно'
    grep -Fq '## 🛠 Що зробив' AGENTS.md \
        || fail 'карта правил не містить заголовка «## 🛠 Що зробив» · звіт може втратити опис виконаних змін'
    grep -Fq '## ➡️ Що далі' AGENTS.md \
        || fail 'карта правил не містить заголовка «## ➡️ Що далі» · звіт може втратити наступні кроки'
