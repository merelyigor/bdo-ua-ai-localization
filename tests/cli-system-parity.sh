...
# 4. Неповний час · помилка в ОБОХ.
#
# Саме тут жила розбіжність, знайдена 2026-09-12: перша редакція порту мала
# `strtotime` як другий шанс і мовчки давала опівніч, тоді як bash на macOS
# рядок без часу відхиляє. Тест лишається як межа: PHP приймає рівно
# документований формат.
pair 'start-без-часу' start '2026-09-12'
pair 'start-сміття' start 'учора ввечері'
