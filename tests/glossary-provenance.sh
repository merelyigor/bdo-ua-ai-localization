...
# Ремонт машинних підказок НЕ отримує взагалі · і це сильніша межа, ніж
# «використовуй, але не як закон». Він працює за наказом «ужий «X» для «Y»», де
# X уже доведено людською назвою; додати йому машинний стандарт означало б дати
