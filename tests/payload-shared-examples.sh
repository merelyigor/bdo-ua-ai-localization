...
# Нагадування «почни нову сесію» більше НЕ мусить існувати.
#
# Воно рахувало payload, що осідав у транскрипті диригента. Драйвер транскрипту
# не має: модель бачить рівно один payload за виклик, а стан лежить на диску.
