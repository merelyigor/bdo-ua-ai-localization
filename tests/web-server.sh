...
#    localStorage вкладки (`web/app.js`), тому `curl` на сторінку не має його
#    бачити. Саме localStorage, а не sessionStorage: останній привʼязаний до
#    ВКЛАДКИ, і прогін, відкритий у новій, лишався б без токена.
#
