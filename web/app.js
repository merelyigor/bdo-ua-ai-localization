...
(function (global) {
  ...
  function streamFeed(buffer, thinkBuffer) {
    ...
    function paint() {
      ...
      // Щойно пішла ВІДПОВІДЬ, роздуми вже скінчились · показуємо їх миттєво.
      // Ознака надійна саме тому, що модель не змішує фази: спершу чернетка,
      // потім текст. Інакше після перезавантаження обидва вікна набирали текст
      // разом, і власник не міг зрозуміти, яке з них справді живе.
      if (thinkBuffer) { thinkBuffer.sync(think, raw !== ''); }
    }
